...
***Arma 3 server config files: [Basic.cfg](../repository/games/steamcmd/arma/arma3/egg-arma3-config/basic.cfg), [Server.cfg](../repository/games/steamcmd/arma/arma3/egg-arma3-config/server.cfg)!***
___
